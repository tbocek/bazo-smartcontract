...
\begin{figure}[H]
	\begin{center}
	\includegraphics[width=0.45\textwidth]{./images/tokenize-function}
	\caption{Tokenize Function}
	\label{tokenizefunc}
	\end{center}
\end{figure}
...
Code snippet \ref{basiccontract} shows a basic contract written in \flqq Enhanced Bazo Byte Code\frqq{}. Code snippet \ref{tokenset} shows generated the tokenSet to the contract.
