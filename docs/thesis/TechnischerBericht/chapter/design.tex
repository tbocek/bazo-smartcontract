...
As the VM just executes the instructions it receives without any checks, it could enter an error state and panic. It must not be possible to crash the miner with a malicious or erroneous contract. \\ \\
